...
// ParseROS2MessageDefinition parses a ROS2 IDL message definition and returns a
// schema.Schema representation of it.
func ParseROS2MessageDefinition(pkg string, name string, msgdef []byte) (*schema.Schema, error) {
